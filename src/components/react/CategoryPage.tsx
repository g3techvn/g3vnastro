        ...
        <div className="flex items-center px-4 py-4">
          ...
          <div className="flex items-center">
            {categoryData.image_url && (
              <img src={categoryData.image_url} alt={categoryData.title} className="w-10 h-10 rounded-full mr-3" />
            )}
            <div>
              <h1 className="text-lg font-semibold text-gray-900">{categoryData.title}</h1>
              ...
              <div className="md:hidden">
                ...
                <div className="py-2 border-b border-gray-100">
                  <nav className="flex items-center text-xs">
                    ...
                    <span className="text-gray-900 font-medium truncate">{categoryData.title}</span>
                  </nav>
                </div>
